...
public static class LightEntityExtensionMethods
{
    ...
    public static void Toggle(this IEnumerable<Lights.Light> target, LightToggleParameters data)
    {
    ...
    public static void TurnOff(this IEnumerable<Lights.Light> target, LightTurnOffParameters data)
    {
    ...
    ///<param name="transition">Duration it takes to get to next state.</param>
    ///<param name="flash">If the light should flash.</param>
    public static void TurnOff(this IEnumerable<Lights.Light> target, long? @transition = null, string? @flash = null)
    {
    ...
    public static void TurnOn(this IEnumerable<Lights.Light> target, LightTurnOnParameters data)
    {
