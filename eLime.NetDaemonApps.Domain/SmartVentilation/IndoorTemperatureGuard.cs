...
public class IndoorTemperatureGuard : IDisposable
{
    ...
    public (VentilationState? State, bool Enforce) GetDesiredState(Climate climate)
    {
        ...
        _logger.LogInformation("Indoor temperature guard: OutdoorTemperatureSensor: {OutdoorTemperatureSensor}. CurrentTemperature: {CurrentTemperature}", OutdoorTemperatureSensor.State, climate.Attributes.CurrentTemperature);
