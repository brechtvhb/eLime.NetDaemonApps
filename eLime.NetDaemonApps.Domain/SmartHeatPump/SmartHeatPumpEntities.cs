...
public class SmartHeatPumpEntities(IMqttEntityManager mqttEntityManager) : IDisposable
{
    ...
    internal async Task Publish()
    {
        ...
        await mqttEntityManager.CreateAsync(heatCoefficientOfPerformanceSensorName, new EntityCreationOptions(UniqueId: heatCoefficientOfPerformanceSensorName, Name: "Heat coefficient of performance", DeviceClass: "", Persist: true), coefficientOfPerformanceSensorOptions);
        await mqttEntityManager.CreateAsync(hotWaterCoefficientOfPerformanceSensorName, new EntityCreationOptions(UniqueId: hotWaterCoefficientOfPerformanceSensorName, Name: "Hot water coefficient of performance", DeviceClass: "", Persist: true), coefficientOfPerformanceSensorOptions);
    }
